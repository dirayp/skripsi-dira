        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="transaksi">
            <ul class="navbar-nav ps-3">
              ...
              <li class="nav-item">
                <a href="trx-keluar.php" class="nav-link active px-3">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Transaksi Keluar</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Transaksi Keluar</h6>
        </nav>
    ...
    <div class="col-12">
      <div class="card mb-4">
        <div class="card-header pb-0">
          ...
          <form action="excel-trxkeluar.php" method="POST">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="aksi/tambah-trxkeluar" method="POST">
                    <div class="form-group">
                    <label class="col-form-label">Tanggal Jual</label>
                    ...
                    <input type="number" name="jml_barangkeluar" id="jml_barangkeluar" class="form-control" required="" placeholder="-" onkeyup="sum();">
                    </div>
                    <div class="form-group">
                    <label class="col-form-label">Harga Jual</label>
                    <input type="number" name="harga_jual" id="harga_jual" class="form-control" required="" placeholder="-" onkeyup="sum();">
                    </div>
                    <div class="form-group">
        ...
        <div class="card-body px-0 pt-0 pb-2">
          <div class="table-responsive p-0">
            <table class="display" id="example" style="width:100%">
              <thead>
                <tr>
                  <th class="text-center text-dark text-secondary text-sm font-weight-bolder opacity-7">No</th>
                      <th class="text-dark text-secondary text-sm font-weight-bolder opacity-7 ps-2">Tgl Jual</th>
                      ...
                      <th class="text-dark text-secondary text-sm font-weight-bolder opacity-7 ps-2">Jumlah Barang Keluar</th>
                      <th class="text-dark text-secondary text-sm font-weight-bolder opacity-7 ps-2">Satuan</th>
                      <th class="text-dark text-secondary text-sm font-weight-bolder opacity-7 ps-2">Harga Jual</th>
              ...
              <tbody>
                    <?php
                      $query = mysqli_query($koneksi,"SELECT * FROM trx_keluar INNER JOIN admin ON trx_keluar.id_admin = admin.id_admin ORDER BY admin.username, trx_keluar.id_trxkeluar DESC");
                      $no = 1;
                      while ($trx_keluar = mysqli_fetch_array($query)) {
                      $masterbarang = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM master_barang WHERE id_namabarang='$trx_keluar[id_namabarang]'"));
                    ?>
                ...
                <tr>
                    <td class="align-middle text-center">
                        ...
                        <td class="align-middle text-secondary">
                          <span class="text-secondary text-dark text-sm font-weight-bold">
                            <?php echo ucwords(strtolower($trx_keluar['username'])); ?>
                          </span>
                        </td>
                        <td class="align-middle text-secondary">
                          <span class="text-secondary text-dark text-sm font-weight-bold">
                        ...
                        <td class="align-middle text-secondary">
                          <span class="text-secondary text-dark text-sm font-weight-bold">
                            <?php echo number_format($trx_keluar['jml_barangkeluar'], 0, ',', '.'); ?>
                          </span>
                        </td>
                        <td class="align-middle text-uppercase">
                          <span class="text-uppercase text-dark text-sm font-weight-bold">
                        ...
                        <td class="align-middle text-secondary">
                          <span class="text-secondary text-dark text-sm font-weight-bold">
                            <?php echo number_format($trx_keluar['harga_jual'], 0, ',', '.'); ?>
                          </span>
                        </td><td class="align-middle text-secondary">
                          <span class="text-secondary text-dark text-sm font-weight-bold">
                            <?php echo number_format($trx_keluar['total'], 0, ',', '.'); ?>
                          </span>
                        </td>
                        <td class="text-center">
                        <a href="aksi/hapus-trxkeluar/<?php echo $trx_keluar['id_trxkeluar']; ?>" onclick="return confirm('HAPUS DATA TRANSAKSI KELUAR INI ?')" style="color: red;"><i class="fa fa-trash"></i></a>&nbsp;&nbsp;
                        <a href="inc/edit-trxkeluar/<?php echo $trx_keluar['id_trxkeluar']; ?>" style="color: blue;"><i class="fa fa-edit"></i></a>
                    </td>
                </tr>
                <?php $no++; } ?>
              </tbody>
...
<footer class="footer pt-3">
  ...
  <script>
    function sum() {
        ...
        var jml_barangkeluar = document.getElementById('jml_barangkeluar').value;
        var result = (parseInt(harga_jual) * parseInt(jml_barangkeluar));
        if (!isNaN(result)) {
