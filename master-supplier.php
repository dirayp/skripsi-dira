        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="masterdata">
            <ul class="navbar-nav ps-3">
              ...
              <li class="nav-item">
                <a href="master-supplier.php" class="nav-link active px-3">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="aksi/tambah-mastersupplier" method="POST">
              ...
              <thead>
                <tr>
                  <th class="text-center text-dark text-secondary text-sm font-weight-bolder opacity-7">No</th>
                      ...
                      <th class="text-dark text-secondary text-sm font-weight-bolder opacity-7 ps-2">Alamat</th>
                      <th class="text-dark text-secondary text-sm font-weight-bolder opacity-7 ps-2">No Telp</th>
                      <th class="text-dark text-secondary text-sm font-weight-bolder opacity-7">Aksi</th>
                </tr>
              </thead>
              <tbody>
                    <?php
                      $query = mysqli_query($koneksi,"SELECT * FROM master_supplier INNER JOIN admin ON master_supplier.id_admin = admin.id_admin ORDER BY admin.username, master_supplier.id_namasupplier DESC");
                      $no = 1;
                ...
                <tr>
                    <td class="align-middle text-center">
                        ...
                        <td class="align-middle text-secondary">
                          <span class="text-secondary text-dark text-sm font-weight-bold">
                            <?php echo ucwords(strtolower($master_supplier['username'])); ?>
                          </span>
                        </td>
                        <td class="align-middle text-secondary">
                          <span class="text-secondary text-dark text-sm font-weight-bold">
                            <?php echo ucwords(strtolower($master_supplier['nama_supplier'])); ?>
                          </span>
                        </td>
                        <td class="align-middle text-secondary">
                          <span class="text-secondary text-dark text-sm font-weight-bold">
                            <?php echo $master_supplier['alamat']; ?>
                          </span>
                        </td>
                        <td class="align-middle text-secondary">
                          <span class="text-secondary text-dark text-sm font-weight-bold">
                            <?php echo $master_supplier['no_telp']; ?>
                          </span>
                        </td>
                        <td class="text-center">
                        <a href="aksi/hapus-mastersupplier/<?php echo $master_supplier['id_namasupplier']; ?>" onclick="return confirm('HAPUS DATA SUPPLIER INI ?')" style="color: red;"><i class="fa fa-trash"></i></a>&nbsp;&nbsp;
                        <a href="inc/edit-mastersupplier/<?php echo $master_supplier['id_namasupplier']; ?>" style="color: blue;"><i class="fa fa-edit"></i></a>
                    </td>
                </tr>
                <?php $no++; } ?>
              </tbody>
