      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Edit Transaksi Keluar</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Edit Transaksi Keluar</h6>
        </nav>
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <?php
                  ...
                  $query = mysqli_query($koneksi,"SELECT * FROM trx_keluar WHERE id_trxkeluar='$id_trxkeluar'");
                  $ambil = mysqli_fetch_array($query);
                ?>
                  <div class="card-body ">
                  <a href="../../trx-keluar" class="btn btn-danger btn-sm"><i class="fa fa-arrow-left"></i> Kembali</a>
                  <hr style="margin-top: 13px;">
                  <form class="form-horizontal" action="../../aksi/update-trxkeluar/<?php echo $ambil['id_trxkeluar'];?>" method="POST">
                ...
                ?>
                  ...
                  <div class="form-group row">
                  <label class="col-sm-3 text-sm control-label">Tanggal Jual</label>
                  <div class="col-sm-3">
                  <input type="date" name="tgl_jual" class="form-control" value="<?php echo $ambil['tgl_jual'];?>">
                  </div>
                  </div>
                  <div class="form-group row">
                  <label class="col-sm-3 text-sm control-label">Jumlah Barang Keluar</label>
                  <div class="col-sm-3">
                  <input type="number" id="jml_barangkeluar" name="jml_barangkeluar" class="form-control" value="<?php echo $ambil['jml_barangkeluar'];?>" onchange="calculateTotal()">
                  </div>
                  </div>
                  <div class="form-group row">
                  <label class="col-sm-3 text-sm control-label">Harga Jual</label>
                  <div class="col-sm-3">
                  <input type="number" id="harga_jual" name="harga_jual" class="form-control" value="<?php echo $ambil['harga_jual'];?>" onchange="calculateTotal()">
                  </div>
                  </div>
                  <div class="form-group row">
                  ...
                  var jml_barangkeluar = parseFloat(document.getElementById('jml_barangkeluar').value) || 0;
                  var result = harga_jual * jml_barangkeluar;
