    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder text-white mb-0">Edit Supplier</h6>
        </nav>
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <?php
                  ...
                  $query = mysqli_query($koneksi,"SELECT * FROM master_supplier WHERE id_namasupplier='$id_namasupplier'");
                  $ambil = mysqli_fetch_array($query);
                ?>
                  <div class="card-body ">
                  <a href="../../master-supplier" class="btn btn-danger btn-sm"><i class="fa fa-arrow-left"></i> Kembali</a>
                  <hr style="margin-top: 13px;">
                  <form class="form-horizontal" action="../../aksi/update-mastersupplier/<?php echo $ambil['id_namasupplier'];?>" method="POST">
                ...
                ?>
                  ...
                  <div class="col-sm-3">
                  <input type="text" name="nama_supplier" class="form-control" value="<?php echo $ambil['nama_supplier']; ?>">
                  </div>
                  </div>
                  <div class="form-group row">
                  <label class="col-sm-3 text-sm control-label">Alamat</label>
                  <div class="col-sm-3">
                  <input type="text" name="alamat" class="form-control" value="<?php echo $ambil['alamat']; ?>">
                  </div>
                  </div>
                  <div class="form-group row">
                  <label class="col-sm-3 text-sm control-label">No Telp</label>
                  <div class="col-sm-3">
                  <input type="text" name="no_telp" class="form-control" value="<?php echo $ambil['no_telp']; ?>">
                  </div>
                  </div>
                  <hr>
