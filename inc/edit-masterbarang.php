      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Edit Barang</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Edit Barang</h6>
        </nav>
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <?php
                  ...
                  $query = mysqli_query($koneksi,"SELECT * FROM master_barang WHERE id_namabarang='$id_namabarang'");
                  $ambil = mysqli_fetch_array($query);
                ?>
                  <div class="card-body ">
                  <a href="../../master-barang" class="btn btn-danger btn-sm"><i class="fa fa-arrow-left"></i> Kembali</a>
                  <hr style="margin-top: 13px;">
                  <form class="form-horizontal" action="../../aksi/update-masterbarang/<?php echo $ambil['id_namabarang'];?>" method="POST">
                ...
                ?>
                  ...
                  <div class="col-sm-3">
                  <input type="text" name="nama_barang" class="form-control" value="<?php echo $ambil['nama_barang']; ?>">
                 </div>
                 </div>
                 <div class="form-group row">
                 <label class="col-sm-3 text-sm control-label">Satuan</label>
                 <div class="col-sm-3">
                 <input type="text" name="satuan" class="form-control" value="<?php echo $ambil['satuan']; ?>">
                 </div>
                 </div>
                 <div class="form-group row">
                 <label class="col-sm-3 text-sm control-label">Ukuran</label>
                 <div class="col-sm-3">
                 <input type="text" name="ukuran" class="form-control" value="<?php echo $ambil['ukuran']; ?>">
                  </div>
                 </div>
                 <div class="form-group row">
                 <label class="col-sm-3 text-sm control-label">Warna</label>
                 <div class="col-sm-3">
                 <input type="text" name="warna" class="form-control" value="<?php echo $ambil['warna']; ?>">
                 </div>
                 </div>
                 <hr>
