          ...
          <div class="card mb-4">
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                ...
                ?>
                  <div class="card-body ">
                  <a href="../../master-admin" class="btn btn-danger btn-sm"><i class="fa fa-arrow-left"></i> Kembali</a>
                  <hr style="margin-top: 13px;">
                  <form class="form-horizontal" action="../../aksi/update-admin/<?php echo $ambil['id_admin'];?>" method="POST">
                  <div class="form-group row">
                  <label class="col-sm-3 text-sm control-label">Nama Pengguna</label>
                  <div class="col-sm-3">
                  <input type="text" name="username" class="form-control" value="<?php echo $ambil['username']; ?>">
                  </div>    
                  </div>
                  <div class="form-group row">
                  <label class="col-sm-3 text-sm control-label">Kata Sandi</label>
                  <div class="col-sm-3">
                  <input type="text" name="password" class="form-control" value="<?php echo $ambil['password']; ?>">
                  </div>
                  </div>
                  <hr>
