        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="masterdata">
            <ul class="navbar-nav ps-3">
              <li class="nav-item">
                <a href="master-admin.php" class="nav-link active px-3">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="aksi/tambah-admin" method="POST">
            ...
            <table class="display" id="example" style="width:100%">
              <thead>
                <tr>
                  ...
                  <th class="text-dark text-secondary text-sm font-weight-bolder opacity-7 ps-2">Nama Pengguna</th>
                  <th class="text-dark text-secondary text-sm font-weight-bolder opacity-7 ps-2">Kata Sandi</th>
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td class="align-middle text-center">
                    <span class="text-secondary text-dark text-sm font-weight-bold">
                      <a href="aksi/hapus-admin/<?php echo $admin['id_admin']; ?>" onclick="return confirm('HAPUS DATA ADMIN INI ?')" style="color: red;"><i class="fa fa-trash"></i></a>&nbsp;&nbsp;
                      <a href="inc/edit-admin/<?php echo $admin['id_admin']; ?>" style="color: blue;"><i class="fa fa-edit"></i></a>
                    </span>
                  </td>
                </tr>
                <?php $no++; } ?>
